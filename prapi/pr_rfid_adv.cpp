/** \file *********************************************************************
 *
 * pr_rfid_adv - Passport Reader sample program
 *
 * 2006-2010 (c) ARH Inc. (http://www.arhungary.hu)
 ******************************************************************************/

/**
 * Advanced RFID handling example
 *
 * Purpose:
 ...
 *		Execute Passive and Active Authentication. Reads DG1, DG2, DG5,.., DG16 files from the RFID chip.
 *
 */
